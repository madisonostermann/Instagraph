...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    static let demoBar:[[String]] = [
        ["Student Scores", "Student", "Maddie", "Dalton", "Aaron", "Rachel", "Kassie", "Cody"],
        ["Student Scores", "Score", "5", "1", "3", "9", "3", "7"]
    ]
    static let demoLine:[[String]] = [
        ["Month", "July", "Aug", "Sep", "Oct", "Nov", "Dec"],
        ["Temperature", "90.0", "83.2", "69.9", "50.1", "40.0", "35.3"]
    ]
    static let demoMultiLine:[[String]] = [
        ["Month", "July", "Aug", "Sep", "Oct", "Nov", "Dec"],
        ["Temperature", "90.0", "83.2", "69.9", "50.1", "40.0", "35.3", "86.0", "83.2", "74.9", "65", "42.3", "40.0"]
    ]
